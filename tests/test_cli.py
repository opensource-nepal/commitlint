...
class TestCLIGetArgs:
    ...
    @patch(
        "argparse.ArgumentParser.parse_args",
        return_value=MagicMock(quick=True),
    )
    def test__get_args__with_quick(self, *_):
        args = get_args()
...
class TestCLIMain:
    ...
    @patch("sys.stdout.write")
    def test__main__valid_commit_message_using_quick(
        self,
        mock_stdout_write,
        *_,
    ):
    ...
    @patch("sys.stderr.write")
    @patch("sys.exit")
    def test__main__invalid_commit_message_using_quick(
        self,
        mock_sys_exit,
        mock_stderr_write,
        *_,
    ...
    @patch(
        "commitlint.cli.get_args",
        return_value=MagicMock(file="path/to/file.txt", quick=False),
    )
    @patch("sys.stdout.write")
    ...
    @patch(
        "commitlint.cli.get_args",
        return_value=MagicMock(file=None, hash="commit_hash", quick=False),
    )
