...
class QuickPatternValidator(CommitValidator):
    """
    Quick validator for commit messages using the conventional commit regex pattern.
    """
    ...
    def validate(self) -> None:
        """
        Quickly validates the commit message using the regex pattern.
...
class PatternValidator(CommitValidator):
    """Validator for commit message using the conventional commit regex pattern."""
